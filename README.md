...
```powershell
.\scripts\package-release.ps1 -Version 3.7.4 -RuntimeIdentifier win-x64
```

Output:

```text
installer\out\IntelliFillOCR-3.7.4-setup-win-x64.exe
```

Build Linux packages on Linux:

```bash
bash scripts/package-linux.sh 3.7.4 linux-x64 Release
```
