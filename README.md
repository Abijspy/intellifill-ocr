...
```bash
nix-build intellifill-ocr-6.3.4.nix -E \
  'with import <nixpkgs> {}; callPackage ./intellifill-ocr-6.3.4.nix {}'
...
```powershell
.\scripts\package-release.ps1 -Version 6.3.4 -RuntimeIdentifier win-x64
# ARM64:
.\scripts\package-release.ps1 -Version 6.3.4 -RuntimeIdentifier win-arm64
```

Output:

```text
installer\out\IntelliFillOCR-6.3.4-setup-win-x64.exe
```

Build Linux packages on Linux:

```bash
bash scripts/package-linux.sh 6.3.4 linux-x64 Release
# or: bash scripts/package-linux.sh 6.3.4 linux-arm64 Release
```
...
# On ARM64: bash scripts/package-flatpak.sh 6.3.4 linux-arm64 Release
```
...
```bash
bash scripts/package-macos.sh 6.3.4 osx-arm64 Release
# or: bash scripts/package-macos.sh 6.3.4 osx-x64 Release
```
